export const translations = {
  en: {
    ...
    'docs.authentication.title': '🔐 Authentication System',
    'docs.authentication.description': 'Forms use JWT tokens from the Dashboard. Dev mode bypasses this for local development.',
    'docs.authentication.productionFlow': 'Production Flow',
    'docs.authentication.step1Title': 'User in Dashboard clicks \'Open Form\'',
    'docs.authentication.step1Desc': 'Dashboard generates JWT token with user context',
    'docs.authentication.step2Title': 'Form loads with token in URL',
    'docs.authentication.step3Title': 'Runtime validates token',
    'docs.authentication.step3Desc': 'Backend API verifies token authenticity',
    'docs.authentication.step4Title': 'Form executes with user context',
    'docs.authentication.step4Desc': 'userName, roles, processName available in form',
    'docs.authentication.devMode': 'Development Mode',
    'docs.authentication.devModeDesc': 'For local development, use dev credentials instead of Dashboard tokens:',
    'docs.authentication.securityWarning': 'Security Warning',
    'docs.authentication.devModeWarning1': 'ONLY for local development',
    'docs.authentication.devModeWarning2': 'Production MUST have',
    'docs.authentication.devModeWarning3': 'Server-side variable (different per environment, no rebuild)',

    // Environment section
    'docs.environment.title': '🔧 Environment Configuration',
    'docs.environment.description': 'Next.js has two types of environment variables with different behaviors.',
    'docs.environment.buildVsServer': 'Build-Time vs Server-Side',
    'docs.environment.buildTime': 'Build-Time (NEXT_PUBLIC_*)',
    'docs.environment.buildTimeDesc1': 'Client-side accessible',
    'docs.environment.buildTimeDesc2': 'Baked into JavaScript',
    'docs.environment.buildTimeDesc3': 'Rebuild required on change',
    'docs.environment.serverSide': 'Server-Side (no prefix)',
    'docs.environment.serverSideDesc1': 'Server-only access',
    'docs.environment.serverSideDesc2': 'Runtime changeable',
    'docs.environment.serverSideDesc3': 'Restart only (no rebuild)',
    'docs.environment.envReference': 'Complete .env.local Reference',
    'docs.environment.envTable': 'Environment Variables Reference Table',
    'docs.environment.remember': 'Remember',
    'docs.environment.remember1': 'Changed',
    'docs.environment.remember1Action': 'Rebuild',
    'docs.environment.remember2': 'Changed server variable?',
    'docs.environment.remember2Action': 'Restart',

    // Deployment section
    'docs.deployment.title': '📦 Deployment Process',
    'docs.deployment.description': 'Automated deployment via CI/CD pipelines.',
    ...
    'docs.deployment.downloadArtifact': 'Download Artifact',
    'docs.deployment.optionA': 'Option A: GitHub Actions or Azure DevOps',
    'docs.deployment.optionB': 'Option B: Repository',
  ...
  es: {
    ...
    // Authentication section
    'docs.authentication.title': '🔐 Sistema de Autenticación',
    'docs.authentication.description': 'Los formularios usan tokens JWT del Dashboard. El modo dev omite esto para desarrollo local.',
    'docs.authentication.productionFlow': 'Flujo de Producción',
    'docs.authentication.step1Title': 'Usuario en Dashboard hace click en \'Abrir Formulario\'',
    'docs.authentication.step1Desc': 'Dashboard genera token JWT con contexto de usuario',
    'docs.authentication.step2Title': 'Formulario carga con token en URL',
    'docs.authentication.step3Title': 'Runtime valida el token',
    'docs.authentication.step3Desc': 'Backend API verifica autenticidad del token',
    'docs.authentication.step4Title': 'Formulario se ejecuta con contexto de usuario',
    'docs.authentication.step4Desc': 'userName, roles, processName disponibles en el formulario',
    'docs.authentication.devMode': 'Modo Desarrollo',
    'docs.authentication.devModeDesc': 'Para desarrollo local, usá credenciales dev en lugar de tokens del Dashboard:',
    'docs.authentication.securityWarning': 'Advertencia de Seguridad',
    'docs.authentication.devModeWarning1': 'SOLO para desarrollo local',
    'docs.authentication.devModeWarning2': 'Producción DEBE tener',
    'docs.authentication.devModeWarning3': 'Variable server-side (diferente por ambiente, sin rebuild)',

    // Environment section
    'docs.environment.title': '🔧 Configuración de Variables de Entorno',
    'docs.environment.description': 'Next.js tiene dos tipos de variables de entorno con comportamientos diferentes.',
    'docs.environment.buildVsServer': 'Build-Time vs Server-Side',
    'docs.environment.buildTime': 'Build-Time (NEXT_PUBLIC_*)',
    'docs.environment.buildTimeDesc1': 'Accesible desde el cliente',
    'docs.environment.buildTimeDesc2': 'Incrustado en JavaScript',
    'docs.environment.buildTimeDesc3': 'Requiere rebuild al cambiar',
    'docs.environment.serverSide': 'Server-Side (sin prefijo)',
    'docs.environment.serverSideDesc1': 'Solo acceso server',
    'docs.environment.serverSideDesc2': 'Cambiable en runtime',
    'docs.environment.serverSideDesc3': 'Solo restart (sin rebuild)',
    'docs.environment.envReference': 'Referencia Completa .env.local',
    'docs.environment.envTable': 'Tabla de Variables de Entorno',
    'docs.environment.remember': 'Recordá',
    'docs.environment.remember1': 'Cambiaste',
    'docs.environment.remember1Action': 'Rebuild',
    'docs.environment.remember2': '¿Cambiaste variable server?',
    'docs.environment.remember2Action': 'Restart',

    // Deployment section
    'docs.deployment.title': '📦 Proceso de Deployment',
    'docs.deployment.description': 'Deployment automatizado vía pipelines de CI/CD.',
    ...
    'docs.deployment.downloadArtifact': 'Descargar Artifact',
    'docs.deployment.optionA': 'Opción A: GitHub Actions o Azure DevOps',
    'docs.deployment.optionB': 'Opción B: Repositorio',
