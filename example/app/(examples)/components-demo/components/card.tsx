...
export const bizuit_cardDoc: ComponentDoc = {
  ...
  category: 'layout',
  icon: 'Component',
  description: 'Versatile card component for content organization',
  detailedDescription: 'A flexible card component with title, description, header, footer, and multiple variants. Perfect for organizing related content in a visually appealing way.',
  useCases: [
  ...
  props: [
    ...
    { name: 'header', type: 'React.ReactNode', required: false, description: 'Custom header content' },
    { name: 'footer', type: 'React.ReactNode', required: false, description: 'Custom footer content' },
    { name: 'variant', type: "'default' | 'outline' | 'filled'", required: false, default: "'default'", description: 'Visual variant of the card' },
    { name: 'hoverable', type: 'boolean', required: false, default: 'false', description: 'Enable hover shadow effect' },
    { name: 'clickable', type: 'boolean', required: false, default: 'false', description: 'Enable click interaction styling' },
  ],
  codeExample: {
