...
export const bizuit_stepperDoc: ComponentDoc = {
  ...
  category: 'layout',
  icon: 'Component',
  description: 'Multi-step progress indicator component',
  detailedDescription: 'A stepper component for visualizing multi-step processes. Supports horizontal and vertical orientation, clickable steps, and custom icons.',
  useCases: [
  ...
  props: [
    { name: 'steps', type: 'Array<{label: string, description?: string, icon?: ReactNode}>', required: true, description: 'Array of step items' },
    { name: 'currentStep', type: 'number', required: true, description: 'Current active step index (0-based)' },
    { name: 'onChange', type: '(step: number) => void', required: false, description: 'Callback when step is clicked (if clickable)' },
    { name: 'orientation', type: "'horizontal' | 'vertical'", required: false, default: "'horizontal'", description: 'Orientation of the stepper' },
    { name: 'clickable', type: 'boolean', required: false, default: 'false', description: 'Allow clicking on steps to navigate' },
  ],
  codeExample: {
